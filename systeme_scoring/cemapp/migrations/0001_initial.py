# Generated by Django 5.1.3 on 2025-06-02 03:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('niveau_concurrence', models.CharField(choices=[('faible', 'Faible'), ('moyen', 'Moyen'), ('fort', 'Fort')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('directeur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
